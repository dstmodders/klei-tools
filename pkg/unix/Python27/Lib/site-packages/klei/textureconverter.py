...
#                          "../../../../../../tools/bin")
# TEXTURE_CONVERTER = os.path.abspath(
#     os.path.join(TOOL_PATH, "TextureConverter.exe"))
#
#
# def Convert(src_filenames,
#             dest_filename,
#             texture_format="bc3",
...
#         is_newer = is_newer or \
#                    util.IsFileNewer(src_filename_str, dest_filename)
#
...
def Convert(src_filenames,
    ...
    assert texture_format_translation[
        texture_format], "Invalid texture format {}".format(texture_format)
    texture_format = texture_format_translation[texture_format]

    # ktech has multiplatform texture support as a stub, but disabled since only
    # opengl is used. (the support was built in, but the option to define in as
    # a program parameter was left commented out).
...
def MipAndConvert(im,
    ...
    try:
        Convert(src_filenames=filenames,
                dest_filename=dest_filename,
                texture_format=texture_format,
                platform=platform,
                no_premultiply=no_premultiply,
                force=force,
