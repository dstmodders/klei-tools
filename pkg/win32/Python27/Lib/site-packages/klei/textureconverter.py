...
def Convert(src_filenames, dest_filename, texture_format="bc3",
            no_premultiply=False, force=False, platform='opengl',
...
def MipAndConvert(im, dest_filename, platform='opengl', texture_format="bc3",
                  no_premultiply=False, force=False, ignore_exceptions=False):
    ...
    try:
        Convert(src_filenames=filenames, dest_filename=dest_filename,
                texture_format=texture_format, platform=platform,
                no_premultiply=no_premultiply, force=force,
