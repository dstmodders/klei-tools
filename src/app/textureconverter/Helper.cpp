...
const uint32_t NumPixelFormats =
    sizeof(PixelFormatMap) / sizeof(PixelFormatPair);
...
PlatformPair PlatformMap[] = {
    {PLATFORM_OPENGL, "opengl"}, {PLATFORM_OPENGLES2, "gles2"},
    {PLATFORM_D3D9, "d3d9"},     {PLATFORM_XBOX360, "xbox360"},
    {PLATFORM_PS3, "ps3"},       {PLATFORM_PS4, "ps4"},
};
...
const uint32_t NumResizeFilters =
    sizeof(ResizeFilterMap) / sizeof(ResizeFilterPair);
